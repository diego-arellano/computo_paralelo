...
// Función para sacar distancias entre puntos
...
//función para cargar datos (hecho por el profesor)
...
//función para salvar los resultados en un csv (hecho por el profesor)
...
int main(int argc, char** argv) {
    ...
    //establecemos el número de hilos con el que trabajaremos.
